...
enum BalootEncyclopedia {
    static let terms: [BalootGlossaryTerm] = [
        ...
        BalootGlossaryTerm(
            ...
            example: "لو اشترى لاعب حكم سبيت، فأي ورقة سبيت تأخذ الأكلة من أي شكل آخر، حتى لو كان أضعف سبيت."
        ),
        BalootGlossaryTerm(
            id: "up-card",
            category: .bidding,
            ...
            example: "لو كانت الورقة المكشوفة ديمن، فلا يجوز شراء حكم ديمن في الجولة الأولى فقط لغير نفس الشكل."
        ),
        BalootGlossaryTerm(
            id: "ashkal-round",
            category: .bidding,
            ...
            example: "لو مرّ الجميع على الورقة المكشوفة (ديمن)، يفتح المجال في جولة الأشكال لشراء حكم سبيت أو هاص أو شريا."
        ),
        BalootGlossaryTerm(
            id: "sun-over-hokum",
            category: .bidding,
