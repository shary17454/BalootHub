...
enum BalootAcademyCatalog {
    static let lessons: [AcademyLesson] = [
        ...
        beginner(
            ...
            example: "بدأ الخصم بسبيت وأنت تملك سبيت؛ لا تختار ديمن فقط لأنه أعلى نقاطًا.",
            prompt: "بدأت الأكلة بسبيت ولديك سبيت وديمن. ماذا تفعل؟",
            correct: ("follow", "ألعب سبيت"),
            wrong: ("discard", "ألعب ديمن"),
        ...
        beginner(
            ...
            example: "بدأت الأكلة بديمن، ولا تملك ديمن، ومعك حكم؛ في قواعد كثيرة يجب أن تقطع بدل رمي لون عادي.",
        ...
        advanced(
            ...
            wrong: ("random-bid", "قراره لا يعطي أي معلومة"),
        ...
        advanced(
            ...
            prompt: "بدأت بسبيت والخصم رمى حكمًا. ما الاستنتاج القانوني الأقوى؟",
            correct: ("void-suit", "غالبًا لا يملك سبيت"),
            wrong: ("has-many-spades", "غالبًا يملك سبيت كثيرًا"),
