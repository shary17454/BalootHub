    ...
    static let allDefinitions: [GameDefinition] = [
        ...
        GameDefinition(
            ...
            sections: [
                ...
                .cardRanking: "في صن: الآس أعلى ثم 10 ثم K ثم Q ثم J ثم 9 ثم 8 ثم 7. في حكم: الشايب (J) هو الأقوى في نوع الحكم يليه 9 ثم A ثم 10 ثم K ثم Q ثم 8 ثم 7، بينما بقية الأنواع تُرتَّب كما في صن.",
                ...
                .scoring: "تُجمع نقاط الأوراق التي يفوز بها كل فريق عبر الأكلات. في حكم يكون مجموع نقاط الجولة 152 نقطة، وفي صن 130 نقطة (تُضاعف عادة إلى 260 عند احتسابها ضمن هدف المباراة).",
        ...
        GameDefinition(
            ...
            sections: [
                ...
                .cardRanking: "في نوع الحكم فقط: الشايب (J) أقوى ورقة، يليه 9، ثم A، 10، K، Q، 8، 7. بقية الأنواع الثلاثة تُرتَّب كما في صن (A الأعلى وحتى 7 الأضعف).",
                ...
                .scoring: "مجموع نقاط أوراق جولة الحكم 152 نقطة: 62 نقطة من نوع الحكم و30 نقطة من كل نوع آخر (×3).",
        ...
        GameDefinition(
            ...
            sections: [
                ...
                .scoring: "مجموع حكم = 152، ومجموع صن الأساسي = 130 (يُضاعف عادة إلى 260). القيم قابلة للتخصيص من إعدادات التسجيل حسب عرف المجلس.",
